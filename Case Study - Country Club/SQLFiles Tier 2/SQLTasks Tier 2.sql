...
WHERE
	b.starttime >= '2012-09-14 00:00:00' and starttime < '2012-09-15 00:00:00'
	and membercost >= 30
	or guestcost >= 30
...
SELECT
    CONCAT_WS(' ', m1.firstname, m1.surname) AS member,
    CONCAT_WS(' ', m2.firstname, m2.surname) AS recommender
FROM Members AS m1
